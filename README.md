# Dogechain Mainnet Token Creation Tool

A simple frontend tool to create tokens on the Dogechain Mainnet (DOGE) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Dogechain-Mainnet-Doge-Token-Creation-Tool-Without-Coding-and-With-Monetization.git
- And press deploy
- Congrats your Dogechain Mainnet Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Dogechain-Mainnet-Doge-Token-Creation-Tool-Without-Coding-and-With-Monetization
- Upload into your Github repo.
- Edit the file public/config.json and insert your Dogechain Mainnet wallet address for receiving fees. Also set fee in DOGE that you want to charge
